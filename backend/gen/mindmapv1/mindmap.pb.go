...
type MindMap struct {
	...
	Unattached    []*Node `protobuf:"bytes,6,rep,name=unattached,proto3" json:"unattached,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MindMap) GetUnattached() []*Node {
	if x != nil {
		return x.Unattached
	}
	return nil
...
func (x *AddNodeRequest) GetStandalone() bool {
	if x != nil {
		return x.Standalone
	}
	return false
...
type MoveNodeRequest struct {
	...
	MakeStandalone bool `protobuf:"varint,6,opt,name=make_standalone,json=makeStandalone,proto3" json:"make_standalone,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MoveNodeRequest) GetMakeStandalone() bool {
	if x != nil {
		return x.MakeStandalone
	}
	return false
}
...
type CreateFromPromptRequest struct {
	...
	TitleHint     string                 `protobuf:"bytes,2,opt,name=title_hint,json=titleHint,proto3" json:"title_hint,omitempty"` // optional title suggestion
	MaxNodes      int32                  `protobuf:"varint,3,opt,name=max_nodes,json=maxNodes,proto3" json:"max_nodes,omitempty"`   // optional cap on generated nodes
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateFromPromptRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CreateFromPromptRequest) GetTitleHint() string {
	if x != nil {
		return x.TitleHint
	}
	return ""
...
func (x *CreateFromPromptRequest) GetMaxNodes() int32 {
	if x != nil {
		return x.MaxNodes
	}
	return 0
...
const file_mindmap_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\v \x01(\x03R\tupdatedAt\"\xc5\x01\n" +
	"\aMindMap\x12\x0e\n" +
	...
	"\n" +
	"unattached\x18\x06 \x03(\v2\x10.mindmap.v1.NodeR\n" +
	"unattached\"p\n" +
	"\n" +
	"MapSummary\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	...
	"\bposition\x18\x04 \x01(\v2\x14.mindmap.v1.PositionR\bposition\x12\x1e\n" +
	"\n" +
	...
	"\x06map_id\x18\x01 \x01(\tR\x05mapId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\"\xd6\x01\n" +
	...
	"\bposition\x18\x05 \x01(\v2\x14.mindmap.v1.PositionR\bposition\x12'\n" +
	"\x0fmake_standalone\x18\x06 \x01(\bR\x0emakeStandalone\"+\n" +
	"\x12ResetLayoutRequest\x12\x15\n" +
	"\x06map_id\x18\x01 \x01(\tR\x05mapId\"$\n" +
	"\vUndoRequest\x12\x15\n" +
	"\x06map_id\x18\x01 \x01(\tR\x05mapId\"$\n" +
	"\vRedoRequest\x12\x15\n" +
	"\x06map_id\x18\x01 \x01(\tR\x05mapId\"m\n" +
	"\x17CreateFromPromptRequest\x12\x16\n" +
	"\x06prompt\x18\x01 \x01(\tR\x06prompt\x12\x1d\n" +
	"\n" +
	"title_hint\x18\x02 \x01(\tR\ttitleHint\x12\x1b\n" +
	"\tmax_nodes\x18\x03 \x01(\x05R\bmaxNodes2\xcc\x06\n" +
	"\x0eMindMapService\x12>\n" +
	"\tCreateMap\x12\x1c.mindmap.v1.CreateMapRequest\x1a\x13.mindmap.v1.MindMap\x12O\n" +
	"\x13CreateMapFromPrompt\x12#.mindmap.v1.CreateFromPromptRequest\x1a\x13.mindmap.v1.MindMap\x128\n" +
...
var file_mindmap_proto_depIdxs = []int32{
	...
	1,  // 3: mindmap.v1.MindMap.unattached:type_name -> mindmap.v1.Node
	3,  // 4: mindmap.v1.ListMapsResponse.maps:type_name -> mindmap.v1.MapSummary
	2,  // 5: mindmap.v1.SaveMapRequest.map:type_name -> mindmap.v1.MindMap
	0,  // 6: mindmap.v1.AddNodeRequest.position:type_name -> mindmap.v1.Position
	0,  // 7: mindmap.v1.UpdateNodeRequest.position:type_name -> mindmap.v1.Position
	0,  // 8: mindmap.v1.MoveNodeRequest.position:type_name -> mindmap.v1.Position
	4,  // 9: mindmap.v1.MindMapService.CreateMap:input_type -> mindmap.v1.CreateMapRequest
	17, // 10: mindmap.v1.MindMapService.CreateMapFromPrompt:input_type -> mindmap.v1.CreateFromPromptRequest
	5,  // 11: mindmap.v1.MindMapService.GetMap:input_type -> mindmap.v1.GetMapRequest
	6,  // 12: mindmap.v1.MindMapService.ListMaps:input_type -> mindmap.v1.ListMapsRequest
	8,  // 13: mindmap.v1.MindMapService.SaveMap:input_type -> mindmap.v1.SaveMapRequest
	9,  // 14: mindmap.v1.MindMapService.DeleteMap:input_type -> mindmap.v1.DeleteMapRequest
	10, // 15: mindmap.v1.MindMapService.AddNode:input_type -> mindmap.v1.AddNodeRequest
	11, // 16: mindmap.v1.MindMapService.UpdateNode:input_type -> mindmap.v1.UpdateNodeRequest
	12, // 17: mindmap.v1.MindMapService.DeleteNode:input_type -> mindmap.v1.DeleteNodeRequest
	13, // 18: mindmap.v1.MindMapService.MoveNode:input_type -> mindmap.v1.MoveNodeRequest
	14, // 19: mindmap.v1.MindMapService.ResetLayout:input_type -> mindmap.v1.ResetLayoutRequest
	15, // 20: mindmap.v1.MindMapService.Undo:input_type -> mindmap.v1.UndoRequest
	16, // 21: mindmap.v1.MindMapService.Redo:input_type -> mindmap.v1.RedoRequest
	2,  // 22: mindmap.v1.MindMapService.CreateMap:output_type -> mindmap.v1.MindMap
	2,  // 23: mindmap.v1.MindMapService.CreateMapFromPrompt:output_type -> mindmap.v1.MindMap
	2,  // 24: mindmap.v1.MindMapService.GetMap:output_type -> mindmap.v1.MindMap
	7,  // 25: mindmap.v1.MindMapService.ListMaps:output_type -> mindmap.v1.ListMapsResponse
	2,  // 26: mindmap.v1.MindMapService.SaveMap:output_type -> mindmap.v1.MindMap
	2,  // 27: mindmap.v1.MindMapService.DeleteMap:output_type -> mindmap.v1.MindMap
	2,  // 28: mindmap.v1.MindMapService.AddNode:output_type -> mindmap.v1.MindMap
	2,  // 29: mindmap.v1.MindMapService.UpdateNode:output_type -> mindmap.v1.MindMap
	2,  // 30: mindmap.v1.MindMapService.DeleteNode:output_type -> mindmap.v1.MindMap
	2,  // 31: mindmap.v1.MindMapService.MoveNode:output_type -> mindmap.v1.MindMap
	2,  // 32: mindmap.v1.MindMapService.ResetLayout:output_type -> mindmap.v1.MindMap
	2,  // 33: mindmap.v1.MindMapService.Undo:output_type -> mindmap.v1.MindMap
	2,  // 34: mindmap.v1.MindMapService.Redo:output_type -> mindmap.v1.MindMap
